...
MainMenuState::MainMenuState()
{
	...
	itens.push_back(new HighlightItem("Novo Jogo", new Rectangle(Vector2D(posx, posy), Vector2D(280, 50), "destiny"), new Font("Novo Jogo", FONT_PATH + "Aero.ttf", 54, utility::WHITE), utility::INTER_BLUE));
	itens.push_back(new HighlightItem("Highscore", new Rectangle(Vector2D(posx-10, posy + 60), Vector2D(280, 50), "destiny"), new Font("Highscore", FONT_PATH + "Aero.ttf", 54, utility::WHITE), utility::INTER_BLUE));
	itens.push_back(new HighlightItem("Sair", new Rectangle(Vector2D(posx-20, posy + 120), Vector2D(130, 50), "destiny"), new Font("Sair", FONT_PATH + "Aero.ttf", 54, utility::WHITE), utility::INTER_BLUE));
